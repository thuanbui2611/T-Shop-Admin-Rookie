...
const SignIn = () => {
  ...
  return (
    <div className="flex items-center justify-center h-full w-full my-20">
      <div className="border border-blue-gray-100 bg-white shadow-lg rounded-lg">
        <div className="flex flex-wrap items-center">
          <div className="w-full xl:block xl:w-1/2">
            <div className=" py-5 px-2 md:py-15 md:px-24 text-center ">
              <div className="flex flex-col mb-5.5 items-center justify-center">
                <p className="ml-4 text-[#FF7E06] font-black text-3xl md:text-4xl">
                  T-Shop Admin Panel
                </p>
              </div>

              <p className="2xl:px-20 text-lg font-semibold text-black">
                This is a admin panel for the T-Shop website. Only Admin can
                access!
              </p>
          ...
          <div className="w-full border-stroke xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <span className="mb-1.5 block font-medium">Only for Admin</span>
              <h2 className="mb-9 text-2xl font-bold text-black sm:text-title-xl2">
                Sign In to T-Shop Admin
              </h2>
