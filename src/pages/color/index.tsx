...
export default function ColorPage() {
  ...
  const handleSelectColor = (actionName: string, color?: Color) => {
  ...
  return (
    <>
                      ...
                      <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                        <div className="flex items-center space-x-3.5">
                          <button
                            ...
                            onClick={() =>
                              handleSelectColor("Edit color", color)
                            }
                          >
                            <svg
                              width="18px"
                          ...
                          <button
                            ...
                            onClick={() => openConfirmDeleteDiaglog(color)}
                          >
                            <svg
                              className="fill-current"
                              width="18"
      ...
      {confirmDeleteDiaglog && (
        <ConfirmDeleteDialog
          objectName={colorDeleted.name}
          actionDelete={() => handleDeleteColor(colorDeleted)}
