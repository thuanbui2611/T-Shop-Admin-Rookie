...
export default function NotFound() {
      ...
      <div className="min-w-screen min-h-screen bg-blue-100 flex items-center p-5 lg:p-20 overflow-hidden relative">
        <div className="flex-1 min-h-full min-w-full rounded-3xl bg-white shadow-xl p-10 lg:p-20 text-gray-800 relative md:flex items-center text-center md:text-left">
          <div className="w-full flex flex-col items-center justify-center md:items-start md:w-1/2">
            <a className="flex items-center mb-10 lg:mb-16 w-fit" href="/">
              {/* <img
                className=" w-16 md:w-20 relative border-4 border-white rounded-full"
                src="./favicon.ico"
              />
              <p className="p-2 pl-6 pr-3 -ml-4 text-3xl font-bold md:text-4xl text-white bg-orange-based">
                Motormate
              </p> */}
              <svg
                className="h-14 md:h-18 relative"
            ...
            <div className="mb-10 md:mb-20 text-gray-600 font-normal">
              <h1 className="font-black uppercase text-3xl lg:text-5xl text-[#ed452b] mb-10">
                You seem to be lost!
              </h1>
            ...
            <div className="mb-20 md:mb-0">
              <Link
                to="/"
                className="text-xl px-2 font-bold outline-none focus:outline-none transform transition-all hover:scale-110 text-orange-based/90 hover:text-orange-based"
              >
                Go Back
              </Link>
            </div>
  ...
  `}</style>
      ...
      <div className="flex items-end justify-end fixed bottom-0 right-0 mb-4 mr-4 z-10 bg-transparent">
        <div>
          <Link
